...
public class ObjectFactory {
    ...
    private final static QName _CharaparserVersion_QNAME = new QName("", "charaparser_version");
    private final static QName _GlossaryName_QNAME = new QName("", "glossary_name");
    private final static QName _GlossaryVersion_QNAME = new QName("", "glossary_version");
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "charaparser_version")
    public JAXBElement<String> createCharaparserVersion(String value) {
        return new JAXBElement<String>(_CharaparserVersion_QNAME, String.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "glossary_name")
    public JAXBElement<String> createGlossaryName(String value) {
        return new JAXBElement<String>(_GlossaryName_QNAME, String.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "glossary_version")
    public JAXBElement<String> createGlossaryVersion(String value) {
        return new JAXBElement<String>(_GlossaryVersion_QNAME, String.class, null, value);
    }
